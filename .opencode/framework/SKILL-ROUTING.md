...
| **Nuevo módulo frontend** | api-first-spec → api-first-frontend → angular | typescript, design-system, i18n | delivery |
...
| **Bugfix frontend** | angular → typescript | unit-testing | delivery |
...
N33: angular              → delivery
N34: angular-services     → delivery
