...
- SIEMPRE sigue el stack declarado (Python/FastAPI, Angular, Bun, PostgreSQL)
...
| Condición | Skills delegadas |
|-----------|-----------------|
| Implementación de código | api-first-backend, api-first-frontend, angular, angular-services |
